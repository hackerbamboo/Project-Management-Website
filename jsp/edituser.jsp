...
try
{
	...
	out.println("<tr><td><b>E-mail:</b></td><td><input type=\"email\" id=\"Email\"  value=\"" + rs.getString("email") + "\">");
	out.println("<tr><td><b>New Password:</b></td><td><input type=\"password\" id=\"Password\"  value=\"" + rs.getString("password") + "\">");
